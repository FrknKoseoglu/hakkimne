...
const FEATURE_TYPES = [
  ...
  { value: "RENT_CALC", label: "Kira Artış Oranı" },
  { value: "SALARY_RAISE_CALC", label: "Maaş Zammı" },
  { value: "MTV_CALC", label: "MTV Hesaplama" },
  { value: "RESIGNATION_LETTER", label: "İstifa Dilekçesi" },
