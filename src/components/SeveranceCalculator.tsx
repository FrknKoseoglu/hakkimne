...
export function SeveranceCalculator() {
  ...
  return (
    <div className="w-full space-y-8">
      ...
      <div id="frame" style={{ width: "100%", margin: "2rem auto", position: "relative", zIndex: 99998 }}>
        <iframe 
          data-aa='2421728' 
          src='//acceptable.a-ads.com/2421728/?size=Adaptive&background_color=transparent&title_color=2463eb&title_hover_color=2463eb&text_color=333&link_color=333&link_hover_color=2463eb'
          style={{ border: 0, padding: 0, width: "70%", height: "250px", overflow: "hidden", display: "block", margin: "auto" }}
        ></iframe>
      </div>
